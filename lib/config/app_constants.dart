class AppConstants {
// Codecanyon
  static const String baseUrl = 'https://demo.imarketku.app/api';
  // QA Testing
  //static const String baseUrl = 'https://uat.imarketku.app/api';
  // static const String baseUrl = 'http://chat.razinsoft.site/api';
  // Development
  // static const String baseUrl = 'https://dev.imarketku.app/api';
