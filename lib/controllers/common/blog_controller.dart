  ...
  Future<void> getBlogList({
    ...
    try {
      ...
      final response = await ref
          ...
          .getBlogs(page: page, perPage: perPage, categoryId: categoryId);
      ...
      state = AsyncData(
        newData.copyWith(data: newData.data.copyWith(blogs: updatedBlogs)),
      );
    } catch (error) {
...
final blogDetailsProvder = StateNotifierProvider.family<
  BlogDetailsController,
  AsyncValue<BlogDetails>,
  int
>((ref, blogId) => BlogDetailsController(ref: ref, blogId: blogId));
