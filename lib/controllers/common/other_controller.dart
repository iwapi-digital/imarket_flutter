...
import 'package:imarketku/models/common/contact_us.dart';
import 'package:imarketku/models/eCommerce/authentication/user.dart';
import 'package:imarketku/services/common/other_service_provider.dart';
...
class TermsAndConditionController
  ...
  TermsAndConditionController(this.ref) : super(const AsyncValue.loading());
...
class PrivacyPolicyController
  ...
  PrivacyPolicyController(this.ref) : super(const AsyncValue.loading());
...
class SupportController extends StateNotifier<bool> {
  ...
  SupportController(this.ref) : super(false);
