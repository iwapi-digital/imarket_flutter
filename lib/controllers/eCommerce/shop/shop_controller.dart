...
import 'package:imarketku/models/eCommerce/product/product.dart';
import 'package:imarketku/models/eCommerce/shop/shop.dart' as shop_model;
import 'package:imarketku/models/eCommerce/shop/shop_details.dart';
import 'package:imarketku/models/eCommerce/shop/shop_review.dart';
import 'package:imarketku/services/eCommerce/shop_service/shop_service.dart';

final shopControllerProvider = StateNotifierProvider<ShopController, bool>((
  ref,
) {
...
class ShopDetailsController extends StateNotifier<AsyncValue<ShopDetails>> {
  ...
  ShopDetailsController(this.ref) : super(const AsyncValue.loading());
...
class ShopCategoriesController
  ...
  ShopCategoriesController(this.ref) : super(const AsyncValue.loading());

  Future<void> getShopCategories({required int shopId}) async {
    try {
      final response = await ref
          .read(shopServiceProvider)
          .getShopCategories(shopId: shopId);
