...
import 'package:imarketku/models/eCommerce/return_policy/return_order_list_model/return_order_list_model.dart';
import 'package:imarketku/models/eCommerce/return_policy/return_order_submit_model.dart';
import 'package:imarketku/services/eCommerce/return_product/return_product_service.dart';
...
final returnOrderListProvider = StateNotifierProvider<
  ReturnOrderListController,
...
final returnOrderDetailsControllerProvider = StateNotifierProvider.family
    .autoDispose<
      ...
      AsyncValue<ReturnOrderDetailsModel>,
      int
    >((ref, shopId) {
...
class ReturnOrderDetailsController
  ...
  ReturnOrderDetailsController(this.ref) : super(const AsyncValue.loading());
