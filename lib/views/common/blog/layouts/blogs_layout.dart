...
import 'package:imarketku/controllers/common/blog_controller.dart';
...
class BlogsLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [_BlogFilterWidget(), _BlogListWidget()]),
    );
  }
}
          ...
          data: (data) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return BlogCardWidget(blog: data.data.blogs[index]);
              },
            );
          },
...
final selectedBlogProvider = StateProvider<Categories>(
  (ref) => Categories(id: 0, name: 'All Brands'),
);
