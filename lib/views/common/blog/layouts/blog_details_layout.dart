...
import 'package:imarketku/models/common/blog_details.dart';
import 'package:imarketku/utils/context_less_navigation.dart';
import 'package:imarketku/utils/global_function.dart';
import 'package:imarketku/views/common/blog/componants/social_platform_card.dart';
...
class BlogDetailsLayout extends ConsumerWidget {
  final int blogId;
  const BlogDetailsLayout({super.key, required this.blogId});
...
class _BlogDetails extends StatelessWidget {
  ...
  const _BlogDetails({required this.blogDetails});
      ...
      child: Container(
        ...
        child: Center(
          child: Text(
            ...
            style: AppTextStyle(
              context,
            ).bodyTextSmall.copyWith(color: Theme.of(context).primaryColor),
          ),
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Related Keywords', style: AppTextStyle(context).buttonText),
          Gap(8.h),
          Wrap(
            spacing: 8.w,
            runSpacing: 8.h,
...
class _SocialNetworkWidget extends StatelessWidget {
            ...
            child: Row(
              children: List.generate(
                ...
                (index) => SocialPlatformCard(
                  ...
                  color: Color(int.parse(socialNetworks[index]['color']!)),
                  onTap:
                      () => _redirectToPlatform(
  ...
  List<Map> socialNetworks = [
    {'icon': Assets.svg.facebook, 'name': 'Facebook', 'color': '0xFF0D68F1'},
    {'icon': Assets.svg.linkedIn, 'name': 'Linkedin', 'color': '0xFF1275B1'},
    {'icon': Assets.svg.twitter, 'name': 'Twitter', 'color': '0xFF47ACDF'},
    {'icon': Assets.svg.pinterest, 'name': 'Pinterest', 'color': '0xFFBB0F23'},
  ];
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            ...
            children: List.generate(blogDetails.data.relatedBlogs.length, (
              index,
            ) {
