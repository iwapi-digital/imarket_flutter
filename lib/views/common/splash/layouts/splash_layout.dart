...
import 'package:imarketku/components/ecommerce/offline.dart';
  ...
  void initState() {
    ...
    ConnectivityWrapper.instance.onStatusChange.listen((event) {
      if (event == ConnectivityStatus.CONNECTED) {
        ...
        Future.wait([ref.read(hiveServiceProvider).loadTokenAndUser()]).then((
          data,
        ) {
                    ...
                    children: [
                      ValueListenableBuilder(
                        ...
                        builder: (context, settingsBox, _) {
                          ...
                          return Assets.png.splashLogo.image(
                            height: 100.h,
                            width: 200.w,
                          );
                        },
