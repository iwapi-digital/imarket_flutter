...
import 'package:imarketku/controllers/common/country_controller.dart';
...
import 'package:imarketku/models/common/all_country_model/country.dart';
import 'package:imarketku/models/eCommerce/authentication/sign_up.dart';
...
class _SignUpLayoutState extends State<SignUpLayout> {
  ...
  Container buildHeader(BuildContext context) {
    return Container(
      ...
      child: const Center(child: AppLogo(isAnimation: true)),
    );
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Consumer(
                builder: (context, ref, child) {
                  return ref
                      .watch(countryListControllerProvider)
                      .when(
                        loading:
                            () => Center(
                    ...
                    children: [
                      ...
                      Flexible(
                        ...
                        child: CustomTextFormField(
                          ...
                          textInputAction: TextInputAction.next,
                          validator:
                              (value) => GlobalFunction.phoneValidator(
                                value: value!,
              ...
              CustomTextFormField(
                ...
                textInputAction: TextInputAction.next,
                validator:
                    (value) => GlobalFunction.emailValidator(
                      value: value!,
                      hintText: S.of(context).email,
                      context: context,
                    ),
  ...
  _navigate({required WidgetRef ref}) {
    if (ref
        ...
        true) {
      if (context.mounted) {
        context.nav.pushNamed(Routes.recoverPassword, arguments: false);
      }
    } else {
      if (context.mounted) {
