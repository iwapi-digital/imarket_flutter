...
import 'package:imarketku/components/ecommerce/animate_image.dart';
...
import 'package:imarketku/views/common/authentication/components/pin_put.dart';
                                    ...
                                    .then((response) {
                                      if (response.isSuccess) {
                                        if (widget
                                          ...
                                          ref
                                              .read(
                                                isProfileVefifySuccess.notifier,
                                              )
                                              .state = true;
                                          ref.refresh(
                                            profileInfoControllerProvider,
                                          );
                                          Future.delayed(
