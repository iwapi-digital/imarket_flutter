...
import 'package:imarketku/controllers/common/other_controller.dart';
...
import 'package:imarketku/models/eCommerce/order/order_place_model.dart';
...
import 'package:imarketku/views/eCommerce/checkout/components/add_address_button.dart';
import 'package:imarketku/views/eCommerce/checkout/components/address_card.dart';
import 'package:imarketku/views/eCommerce/checkout/components/address_modal_bottom_sheet.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: ref
          .watch(profileInfoControllerProvider)
          .whenOrNull(
            data: (user) {
              return _buildBottomNavigationBar(
                isProfileVerify: user.accountVerified,
              );
            },
          ),
      body: Container(
              ...
              ? Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ref.read(hiveServiceProvider).getUserInfo().then((
                          userInfo,
                        ) {
                          if (userInfo != null) {
