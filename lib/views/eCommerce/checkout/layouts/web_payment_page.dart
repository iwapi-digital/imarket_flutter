...
import 'package:imarketku/components/ecommerce/custom_dialog.dart';
...
class WebPayementScreen extends ConsumerStatefulWidget {
  ...
  const WebPayementScreen({super.key, required this.webPaymentScreenAr});
...
class WebPaymentScreenArg {
  ...
  WebPaymentScreenArg({this.orderId, required this.paymentUrl});
}
