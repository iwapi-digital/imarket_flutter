...
import 'package:imarketku/views/eCommerce/dashboard/components/app_bottom_navbar.dart';
...
import 'package:imarketku/views/eCommerce/more/more_view.dart';
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: PageView(
          ...
          children: const [
            EcommerceHomeView(),
            EcommerceMyCartView(isRoot: true, isBuyNow: false),
