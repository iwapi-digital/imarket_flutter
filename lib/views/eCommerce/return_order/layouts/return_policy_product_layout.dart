...
import 'package:imarketku/models/eCommerce/return_policy/return_order_submit_model.dart';
...
import 'package:imarketku/views/eCommerce/return_order/componants/return_success_dialouge.dart';

class ReturnPolicyProductLayout extends ConsumerStatefulWidget {
  final int orderId;

  const ReturnPolicyProductLayout({super.key, required this.orderId});
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Container(
          ...
          child:
              ref.watch(returnSubmitControllerProvider)
                  ? SizedBox(
                    height: 60.w,
                    ...
                    onPressed: () {
                      ...
                      if (_formKey.currentState!.validate()) {
                        ...
                        final submitReturnModel = ReturnOrderSubmitModel(
                          ...
                          productIds:
                              selectedProducts.map((e) => e.id).toList(),
                        );

                        ref
                            .read(returnSubmitControllerProvider.notifier)
                            .submitReturnProduct(returnOrder: submitReturnModel)
                            .then((response) {
                              if (response.isSuccess) {
                                ...
                                ref
                                    .read(
                                      selectedReturnProductProvider.notifier,
                                    )
                                    .clearSelection();
                                Future(() async {
                                  await ref
