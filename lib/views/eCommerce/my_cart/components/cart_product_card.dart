...
import 'package:imarketku/components/ecommerce/increment_decrement_button.dart';
...
import 'package:imarketku/views/eCommerce/my_cart/components/gift_bottom_sheet.dart';
...
class CartProductCard extends ConsumerWidget {
  ...
  void _handleGiftTap({
    ...
    showModalBottomSheet(
      ...
      builder:
          (context) =>
              GiftBottomSheet(productId: product.id, gift: product.gift),
    );
  }
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildProductImage(productImage: product.thumbnail),
                  Gap(16.w),
                  _buildProductInfo(
                    context: context,
                    product: product,
    ...
    return Flexible(
      ...
      child: Column(
        ...
        children: [
          ...
          Gap(6.h),
          _buildProductBottomRow(context: context, product: product),
          Gap(8.h),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
      ...
      child: Row(
        ...
        children: [
          ...
          SvgPicture.asset(
            ...
            colorFilter: ColorFilter.mode(
              colors(GlobalFunction.navigatorKey.currentContext!).primaryColor!,
              BlendMode.srcIn,
            ),
          ),
          _senderColumn(
            'Receiver',
            product.gift?.receiverName ?? '',
            isReceiver: true,
          ),
        ],
      ),
