...
import 'package:imarketku/models/eCommerce/cart/cart_product.dart';
import 'package:imarketku/models/eCommerce/cart/hive_cart_model.dart';
...
import 'package:imarketku/views/eCommerce/my_cart/components/cart_product_card.dart';
import 'package:imarketku/views/eCommerce/my_cart/components/voucher_bottom_sheet.dart';
...
class _EcommerceMyCartLayoutState extends ConsumerState<EcommerceMyCartLayout> {
  ...
  Widget build(BuildContext context) {
    return LoadingWrapperWidget(
      ...
      child: Scaffold(
        appBar:
            ref.watch(cartController).cartItems.isEmpty
                ? null
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: AppTextStyle(
              context,
            ).subTitle.copyWith(color: EcommerceAppColor.gray),
          ),
          Gap(30.h),
        ...
        child: Container(
          ...
          child: Center(
            child: Text(
              ...
              style: AppTextStyle(
                context,
              ).buttonText.copyWith(color: EcommerceAppColor.primary),
            ),
          ),
        ),
      ),
  ...
  Widget _buildCartProductList({required CartItem cartItem}) {
    return Container(
                  ...
                  increment: () async {
                    if (!checkMultivendor()) {
                      ...
                      if (ref.read(shopIdsProvider).isNotEmpty) {
                        ...
                        final summery = ref.refresh(
                          cartSummeryController.notifier,
                        );
    ...
    return GestureDetector(
      onTap: () {
        showModalBottomSheet(
          ...
          context: context,
          builder: (context) {
            return VoucherBottomSheet(shopId: shopId, shopName: shopName);
          },
        );
      },
      child: Row(
        children: [
          SvgPicture.asset(Assets.svg.ticket, height: 30.h, width: 30.w),
          Gap(10.w),
          Text(
          ...
          child: Row(
            children: [
              ...
              Checkbox(
                ...
                activeColor: colors(context).primaryColor,
                value:
                    ref.watch(shopIdsProvider).length ==
                    ref.watch(cartController).cartItems.length,
                onChanged: (v) {
  ...
  Widget _buildPromoCodeApplyWidget({required BuildContext context}) {
    return Container(
      ...
      child: Row(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Flexible(flex: 3, child: _buildPromoTextField(context: context)),
          Gap(10.w),
          Material(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      ...
                      style: AppTextStyle(
                        context,
                      ).subTitle.copyWith(color: colors(context).primaryColor),
                    ),
                  ],
                ),
              ),
  ...
  Widget _buildSummaryRow({
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          "${isDiscount ? '-' : ''}${GlobalFunction.price(ref: ref, price: value.toString())}",
          style: AppTextStyle(context).bodyText.copyWith(
            fontWeight: isPayable ? FontWeight.bold : FontWeight.w500,
              ...
              Flexible(
                ...
                child: AbsorbPointer(
                  ...
                  child: CustomButton(
                    ...
                    buttonColor:
                        ref.watch(shopIdsProvider).isNotEmpty
                            ? colors(context).primaryColor
                            : ColorTween(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: EcommerceAppColor.primary, width: 2.2),
        ),
        child:
            isActive
                ? Container(
  ...
  String _getPayableAmount() {
    ...
    payableAmount =
        ref.watch(subTotalProvider.notifier).getSubTotal() != 0.0
