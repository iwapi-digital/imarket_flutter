...
import 'package:imarketku/controllers/eCommerce/authentication/authentication_controller.dart';
import 'package:imarketku/controllers/misc/misc_controller.dart';
import 'package:imarketku/generated/l10n.dart';
import 'package:imarketku/models/eCommerce/authentication/user.dart';
...
import 'package:imarketku/views/common/authentication/components/country_model_bottom_sheet.dart';
                    ...
                    if (formKey.currentState!.validate()) {
                      ...
                      ref
                          ...
                          .updateProfile(
                            userInfo: userInfo,
                            file:
                                ref.read(selectedUserProfileImage) != null
                                    ? File(
                                  ...
                                  children: [
                                    ValueListenableBuilder(
                                      ...
                                      builder: (context, box, _) {
                                        Map<dynamic, dynamic>? userInfo = box
                                            .get(AppConstants.userData);
                                        Map<String, dynamic>
                                        userInfoStringKeys =
...
class VerificationStatusWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(
          horizontal: horizontalGap ?? 16.w,
          vertical: verticalGap ?? 8.h,
        ),
        child: Row(
          children: [
            SvgPicture.asset(
