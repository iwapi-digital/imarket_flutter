...
import 'package:imarketku/models/eCommerce/notification/notification.dart';
...
class _NotificationCardState extends State<NotificationCard> {
  ...
  Widget _buildLeading() {
    return SizedBox(
      width: 47.w,
      child: Row(children: [_buildReadIndicator(), Gap(3.w), _buildAvatar()]),
    );
  }
      ...
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: CachedNetworkImageProvider(
            'https://demo.imarketku.app/assets/favicon.png',
            maxWidth: 30,
          ),
        ),
      ),
      ...
      children: [
        Row(
          children: [
            ...
            Gap(8.w),
            Text('10 days ago', style: AppTextStyle(context).bodyTextSmall),
          ],
        ),
      ],
    );
