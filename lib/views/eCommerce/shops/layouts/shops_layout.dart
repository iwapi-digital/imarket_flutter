...
import 'package:imarketku/views/eCommerce/shops/components/shop_card.dart';
...
class _EcommerceShopsLayoutState extends ConsumerState<EcommerceShopsLayout> {
  ...
  void _fetchShops({required bool isPagination}) {
    ref
        ...
        .getShops(page: page, perPage: perPage, isPagination: isPagination);
  }
                ...
                itemBuilder: (context, index) {
                  ...
                  return AnimationConfiguration.staggeredList(
                    ...
                    child: SlideAnimation(
                      child: FadeInAnimation(child: ShopCard(shop: shop)),
                    ),
                  );
                },
              ),
