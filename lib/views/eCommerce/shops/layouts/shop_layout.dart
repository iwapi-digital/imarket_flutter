...
import 'package:imarketku/components/ecommerce/custom_search_field.dart';
...
import 'package:imarketku/models/eCommerce/shop/shop_details.dart';
...
import 'package:imarketku/views/eCommerce/products/components/review_card.dart';
import 'package:imarketku/views/eCommerce/shops/components/rating_summary.dart';
...
class _EcommerceShopLayoutState extends ConsumerState<EcommerceShopLayout> {
            ...
            Consumer(
              builder: (context, ref, _) {
                final asyncValue = ref.watch(
                  shopDetailsControllerProvider(widget.shopId),
                );
          ...
          Column(
            ...
            children: [
              ...
              Text(
                ...
                style: AppTextStyle(
                  context,
                ).bodyText.copyWith(color: EcommerceAppColor.white),
              ),
            ],
          ),
          const Spacer(),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color:
                      shopDetails.shopStatus == 'Offline'
                ...
                child: Center(
                  child: Text(
                    ...
                    style: AppTextStyle(
                      context,
                    ).bodyTextSmall.copyWith(color: EcommerceAppColor.white),
                  ),
                ),
              ),
              Container(
              ...
              child: AnimatedContainer(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: AppTextStyle(
                      context,
                    ).bodyText.copyWith(color: const Color(0xFF617885)),
                  ),
                ),
              ),
            ),
  ...
  Widget _buildProductsWidget() {
    ...
    return Container(
      ...
      color: colors(context).accentColor,
      child:
          ref.watch(shopControllerProvider) && products.isEmpty
              ? const Center(child: CircularProgressIndicator())
              : AnimationLimiter(
  ...
  Widget _buildCategoriesWidget() {
    final asyncValue = ref.watch(
      shopCategoriesControllerProvider(widget.shopId),
    );
                        ...
                        onTap: () {
                          if (category.subCategories.isNotEmpty) {
                            showModalBottomSheet(
                              context: context,
                              builder:
                                  (context) => SubCategoriesBottomSheet(
                                    category: category,
                                  ),
                            );
                          } else {
