...
class DealOfDayWidget extends StatefulWidget {
  ...
  const DealOfDayWidget({super.key, required this.targetDate});
...
class _DealOfDayWidgetState extends State<DealOfDayWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [_buildDealHeader(), Gap(16.h), _buildScrollingContainers()],
    );
  }
        ...
        Row(
          children: [
            Text(
              ...
              style: AppTextStyle(
                context,
              ).bodyText.copyWith(color: colors(context).light),
            ),
            Gap(10.w),
