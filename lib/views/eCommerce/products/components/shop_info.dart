...
class ShopInformation extends StatelessWidget {
  ...
  const ShopInformation({super.key, required this.productDetails});
        ...
        SizedBox(
          child: Row(
            children: [
              ...
              Gap(10.w),
              Text(text, style: AppTextStyle(context).bodyTextSmall),
            ],
          ),
        ),
        Text(value, style: AppTextStyle(context).bodyTextSmall),
      ],
    );
  }
}
