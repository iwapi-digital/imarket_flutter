...
import 'package:imarketku/views/eCommerce/products/components/iframe_card.dart';
import 'package:imarketku/views/eCommerce/products/components/video_player.dart';

import '../../../../config/app_constants.dart';

class ProductImagePageView extends ConsumerStatefulWidget {
  final ProductDetails productDetails;
  const ProductImagePageView({super.key, required this.productDetails});
