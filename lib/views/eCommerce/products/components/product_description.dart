...
import 'package:imarketku/views/eCommerce/home/layouts/home_view_layout.dart';
import 'package:share_plus/share_plus.dart';

class ProductDescription extends ConsumerStatefulWidget {
  final ProductDetails productDetails;
  const ProductDescription({super.key, required this.productDetails});
        ...
        children: [
          Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  final websiteUrl = AppConstants.baseUrl.replaceAll(
                    "api",
                    "products",
                  );
                  Share.share(
            ...
            child:
                isTextExpanded
                    ? Text(
                      ...
                      style: AppTextStyle(
                        context,
                      ).bodyTextSmall.copyWith(fontSize: 12.sp),
                    )
                    : Text(
                      widget.productDetails.product.shortDescription,
                      style: AppTextStyle(
                        context,
                      ).bodyTextSmall.copyWith(fontSize: 13.sp),
                      maxLines: 3,
          ...
          widget.productDetails.product.runningFlashSale != null
              ? DealOfTheDayWidget(showViewMore: false)
              : const SizedBox(),
        ],
      ),
    );
