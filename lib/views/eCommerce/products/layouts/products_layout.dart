...
import 'package:imarketku/components/ecommerce/product_not_found.dart';
...
import 'package:imarketku/views/eCommerce/products/components/filter_modal_bottom_sheet.dart';
import 'package:imarketku/views/eCommerce/products/components/list_product_card.dart';
...
class _EcommerceProductsLayoutState
    ...
    ref
        ...
        .getCategoryWiseProducts(
          productFilterModel: ProductFilterModel(
            ...
            subCategoryId:
                ref.watch(selectedSubCategory) != 0
  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(
      SystemUiOverlayStyle(statusBarColor: GlobalFunction.getContainerColor()),
    );
    return SafeArea(
      child: Scaffold(
        appBar: PreferredSize(
          preferredSize: const Size.fromHeight(0),
          child: AppBar(elevation: 0, automaticallyImplyLeading: false),
        ),
        ...
        return Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              debugPrint(
                "selected category1 ${ref.watch(selectedSubCategory)}",
              );
              debugPrint(
              ...
              return GestureDetector(
                onTap: () {
                  ...
                  if (ref.watch(selectedSubCategory.notifier).state !=
                    ...
                    _setselectedSubCategory(
                      id: filterCategoryList[index].id!,
                    ).then((_) {
                      _fetchProducts(isPagination: false);
                    });
                  }
...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  _SliverAppBarDelegate({required this.child, this.maxExtentS = 80.0});
