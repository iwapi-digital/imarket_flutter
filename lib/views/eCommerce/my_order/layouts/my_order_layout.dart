      ...
      if (ref.watch(orderControllerProvider.notifier).orders.length <
        ...
        ref
            ...
            .getOrders(
              ...
              perPage: perPage,
              orderStatus:
                  MyOrderLayout.getOrderStatus(context)[ref
                      .read(selectedMyOrderIndexProvider.notifier)
                      .state]['key'],
            );
      }
    }
    ...
    return Expanded(
      child:
          ref.watch(orderControllerProvider)
              ...
              : AnimationLimiter(
                child:
                    ref.watch(orderControllerProvider.notifier).orders.isEmpty
                        ? Center(
                          child: Text(
                            'Order not found!',
            ...
            (context, index) => InkWell(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color:
                      ref.watch(selectedMyOrderIndexProvider) == index
