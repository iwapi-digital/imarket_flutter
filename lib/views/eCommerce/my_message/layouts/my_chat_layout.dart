...
import 'package:imarketku/controllers/eCommerce/pusher/pusher_controller.dart';
import 'package:imarketku/gen/assets.gen.dart';
import 'package:imarketku/models/eCommerce/message_model/messages.dart';
import 'package:imarketku/models/eCommerce/message_model/user.dart';
import 'package:imarketku/models/eCommerce/shop_message_model/product.dart';
...
import 'package:imarketku/views/eCommerce/my_message/components/product_card_widget.dart';
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels >=
        ...
        ref
            .read(getMessageControllerProvider.notifier)
            .getMessage(shopId: widget.shop.id ?? 0);
      }
    });
  }
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    widget.shop.lastOnline == true ? "Active" : "Inactive",
                    style: AppTextStyle(context).bodyText.copyWith(
                      fontSize: 12.sp,
                      color:
                          widget.shop.lastOnline == true
                              ? Colors.green
                              : Colors.grey,
                    ),
                  ),
