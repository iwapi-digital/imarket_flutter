...
import 'package:imarketku/components/ecommerce/confirmation_dialog.dart';
import 'package:imarketku/components/ecommerce/custom_button.dart';
import 'package:imarketku/components/ecommerce/custom_transparent_button.dart';
import 'package:imarketku/config/app_color.dart';
import 'package:imarketku/config/app_constants.dart';
import 'package:imarketku/config/app_text_style.dart';
import 'package:imarketku/config/theme.dart';
import 'package:imarketku/controllers/common/master_controller.dart';
import 'package:imarketku/controllers/eCommerce/cart/cart_controller.dart';
import 'package:imarketku/controllers/eCommerce/message/message_controller.dart';
import 'package:imarketku/controllers/eCommerce/order/order_controller.dart';
import 'package:imarketku/controllers/eCommerce/payment/payment_controller.dart';
import 'package:imarketku/controllers/eCommerce/return_policy/return_policy_controller.dart';
import 'package:imarketku/controllers/misc/misc_controller.dart';
import 'package:imarketku/gen/assets.gen.dart';
import 'package:imarketku/generated/l10n.dart';
import 'package:imarketku/models/eCommerce/order/order_details_model.dart';
import 'package:imarketku/models/eCommerce/shop_message_model/shop.dart'
    as shop;
import 'package:imarketku/routes.dart';
import 'package:imarketku/services/common/hive_service_provider.dart';
import 'package:imarketku/utils/context_less_navigation.dart';
import 'package:imarketku/utils/global_function.dart';
import 'package:imarketku/views/eCommerce/checkout/components/address_card.dart';
import 'package:imarketku/views/eCommerce/checkout/components/build_payment_card.dart';
import 'package:imarketku/views/eCommerce/checkout/components/order_placed_dialog.dart';
import 'package:imarketku/views/eCommerce/checkout/components/pay_card.dart';
import 'package:imarketku/views/eCommerce/checkout/layouts/checkout_layout.dart';
import 'package:imarketku/views/eCommerce/checkout/layouts/web_payment_page.dart';
import 'package:imarketku/views/eCommerce/order_details/components/order_details_card.dart';
import 'package:imarketku/views/eCommerce/order_details/components/order_product_card.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: ref
          .watch(orderDetailsControllerProvider(widget.orderId))
          .when(
            data:
                (orderDetails) =>
      ...
      body: Consumer(
        builder: (context, ref, _) {
          ...
          return asyncValue.when(
            data:
                (orderDetails) => SingleChildScrollView(
                  child: Column(
                    children: [
                      Gap(8.h),
  ...
  Widget _buildServiceItemsWidget(
    ...
    return Consumer(
      builder: (context, ref, child) {
        ...
        final isEnableNextButton = products.any(
          (product) => product.isReturnable == true,
        );
        debugPrint("isEnableNextButton: $isEnableNextButton");
        return Container(
          padding: EdgeInsets.symmetric(vertical: 14.h),
          color:
              showCheckbox == true && isDark
              ...
              showCheckbox == true
                  ? Center(
                    child: Text(
                      ...
                      style: AppTextStyle(
                        context,
                      ).subTitle.copyWith(fontSize: 16.sp),
                    ),
                  )
                  : Padding(
                                ...
                                ref
                                    ...
                                    .then((response) {
                                      final data = ref.refresh(
                                        orderDetailsControllerProvider(orderId),
                                      );
                ...
                itemBuilder: ((context, index) {
                  ...
                  return Padding(
                    ...
                    child: PaymentCard(
                      ...
                      isActive:
                          ref.watch(selectedPayment) == paymentGateway.name,
                      onTap: () {
                        showDialog(
                          context: context,
                          barrierColor: colors(
