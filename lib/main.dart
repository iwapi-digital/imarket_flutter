...
import 'package:imarketku/firebase_options.dart';
...
import 'package:imarketku/utils/notification_handler.dart';
import 'package:imarketku/views/common/splash/layouts/splash_layout.dart';
      ...
      builder: (context, child) {
        return ValueListenableBuilder(
          ...
          builder: (context, box, _) {
            final isDark =
                box.get(AppConstants.isDarkTheme, defaultValue: false) as bool;
