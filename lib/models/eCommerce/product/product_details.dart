...
import 'package:imarketku/models/eCommerce/flash_sales_list_model/running_flash_sale.dart';
...
class Thumbnail {
  ...
  final String? url;
  final String? type;
  Thumbnail({required this.id, required this.thumbnail, this.url, this.type});

  Thumbnail copyWith({int? id, String? thumbnail, String? url, String? type}) {
    return Thumbnail(
      id: id ?? this.id,
...
class Color {
  ...
  final String name;
  final double price;
  Color({required this.id, required this.name, required this.price});

  Color copyWith({int? id, String? name, double? price}) {
    return Color(
      id: id ?? this.id,
      name: name ?? this.name,
      price: price ?? this.price,
