...
import 'package:imarketku/models/eCommerce/address/add_address.dart';
import 'package:imarketku/models/eCommerce/category/category.dart';
import 'package:imarketku/models/eCommerce/order/order_now_cart_model.dart';
import 'package:imarketku/models/eCommerce/shop_message_model/shop.dart';
import 'package:imarketku/views/common/authentication/change_password_view.dart';
import 'package:imarketku/views/common/authentication/confirm_otp_view.dart';
import 'package:imarketku/views/common/authentication/create_new_password_view.dart';
import 'package:imarketku/views/common/authentication/layouts/confirm_otp_layout.dart';
import 'package:imarketku/views/common/authentication/login_view.dart';
import 'package:imarketku/views/common/authentication/recover_password_view.dart';
import 'package:imarketku/views/common/authentication/sign_up_view.dart';
import 'package:imarketku/views/common/blog/blog_details_view.dart';
import 'package:imarketku/views/common/blog/blogs_view.dart';
import 'package:imarketku/views/common/language/language_view.dart';
import 'package:imarketku/views/common/onboarding/onboarding_view.dart';
import 'package:imarketku/views/common/other/privacy_policy_view.dart';
import 'package:imarketku/views/common/other/refund_policy_view.dart';
import 'package:imarketku/views/common/other/terms_confitions_view.dart';
import 'package:imarketku/views/common/splash/splash_view.dart';
import 'package:imarketku/views/common/support/supports_view.dart';
import 'package:imarketku/views/eCommerce/address/add_update_address_view.dart';
import 'package:imarketku/views/eCommerce/categories/categories_view.dart';
import 'package:imarketku/views/eCommerce/checkout/checkout_view.dart';
import 'package:imarketku/views/eCommerce/checkout/layouts/web_payment_page.dart';
import 'package:imarketku/views/eCommerce/dashboard/dashboard_view.dart';
import 'package:imarketku/views/eCommerce/favourites/favourites_products_view.dart';
import 'package:imarketku/views/eCommerce/home/home_view.dart';
import 'package:imarketku/views/eCommerce/home/layouts/flash_sale_details_layout.dart';
import 'package:imarketku/views/eCommerce/manage_address/manage_address_view.dart';
import 'package:imarketku/views/eCommerce/my_cart/my_cart_view.dart';
import 'package:imarketku/views/eCommerce/my_message/my_chat_view.dart';
import 'package:imarketku/views/eCommerce/my_message/my_message_view.dart';
import 'package:imarketku/views/eCommerce/my_order/my_order_view.dart';
import 'package:imarketku/views/eCommerce/notification/notification_view.dart';
import 'package:imarketku/views/eCommerce/order_details/order_details_view.dart';
import 'package:imarketku/views/eCommerce/order_now/order_now_view.dart';
import 'package:imarketku/views/eCommerce/products/product_details_view.dart';
import 'package:imarketku/views/eCommerce/products/products_view.dart';
import 'package:imarketku/views/eCommerce/profile/profile_view.dart';
import 'package:imarketku/views/eCommerce/return_order/layouts/return_order_list_layout.dart';
import 'package:imarketku/views/eCommerce/return_order/return_order_details_view.dart';
import 'package:imarketku/views/eCommerce/return_order/return_policy_product_view.dart';
import 'package:imarketku/views/eCommerce/shops/shop_view.dart';
import 'package:imarketku/views/eCommerce/shops/shops_view.dart';
import 'package:imarketku/views/food/dashboard/dashboard_view.dart';
import 'package:imarketku/views/food/home/home_view.dart';
import 'package:imarketku/views/grocery/dashboard/dashboard_view.dart';
import 'package:imarketku/views/grocery/home/home_view.dart';
import 'package:imarketku/views/pharmacy/dashboard/dashboard_view.dart';
import 'package:imarketku/views/pharmacy/home/home_view.dart';
...
Widget getProductDetailsView(String serviceName, int productId) {
  switch (serviceName) {
    case 'ecommerce':
      return EcommerceProductDetailsView(productId: productId);
    case 'food':
      return const FoodHomeView();
    case 'grocery':
      return const GroceryHomeView();
...
Widget getShopView(String serviceName, int shopId) {
  switch (serviceName) {
    case 'ecommerce':
      return EcommerceShopView(shopId: shopId);
    case 'food':
      return const FoodHomeView();
    case 'grocery':
      return const GroceryHomeView();
...
Widget getMyCartView(String serviceName, bool isRoot, bool isBuyNow) {
  switch (serviceName) {
    case 'ecommerce':
      return EcommerceMyCartView(isRoot: isRoot, isBuyNow: isBuyNow);
    case 'food':
      return const FoodHomeView();
    case 'grocery':
      return const GroceryHomeView();
...
Widget getAddUpdateAddressView(String serviceName, AddAddress? address) {
  switch (serviceName) {
    case 'ecommerce':
      return AddUpdateAddressView(address: address);
    case 'food':
      return const FoodHomeView();
    case 'grocery':
      return const GroceryHomeView();
...
Widget getReturnOrderDetailsView(String serviceName, int orderId) {
  switch (serviceName) {
    case 'ecommerce':
      return ReturnOrderDetailsView(orderId: orderId);
    case 'food':
      return const FoodHomeView();
    case 'grocery':
      return const GroceryHomeView();
...
Widget getOrderNowView(
  ...
  switch (serviceName) {
    case 'ecommerce':
      return EcommerceOrderNowView(orderNowCartModel: orderNowCartModel);
    case 'food':
      return const FoodHomeView();
    case 'grocery':
      return const GroceryHomeView();
...
Widget getReturnOrderListView(String serviceName) {
  switch (serviceName) {
    case 'ecommerce':
...
Widget handleCommonRoutes(String? routeName, RouteSettings settings) {
  switch (routeName) {
    ...
    case Routes.confirmOTP:
      ...
      return ConfirmOTPView(arguments: arguments);
    case Routes.recoverPassword:
      final bool isRecoverPassword = settings.arguments as bool;
      return RecoverPasswordView(isPasswordRecovery: isRecoverPassword);
    case Routes.createPassword:
      final String forgotPasswordToken = settings.arguments as String;
      return CreateNewPasswordView(forgotPasswordToken: forgotPasswordToken);
    ...
    case Routes.webPaymentScreen:
      ...
      return WebPayementScreen(webPaymentScreenAr: webPaymentScreenArg);
    ...
    case Routes.flashSaleDetails:
      return FlashSaleDetailsLayout(title: settings.arguments as String);
    case Routes.bogs:
...
Route generatedRoutes(RouteSettings settings) {
  ...
  if (serviceName != null &&
    ...
    final Widget view = getProductsView(
      serviceName,
      categoryId,
      categoryName,
      sortType,
