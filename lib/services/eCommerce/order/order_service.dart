...
import 'package:imarketku/services/base/eCommerce/order_provider_base.dart';
...
class OrderService implements OrderProviderBase {
  ...
  Future<Response> placeOrder({
    ...
    final response = await ref
        ...
        .post(AppConstants.placeOrderV1, data: orderPlaceModel.toMap());
    return response;
  }
  ...
  Future<Response> cancelOrder({required int orderId}) async {
    final response = await ref
        .read(apiClientProvider)
        .post(AppConstants.cancelOrder, data: {'order_id': orderId});
    return response;
  }
  ...
  Future<Response> buyNow({required BuyNowOrderPlace orderPlaceModel}) async {
    final response = await ref
        .read(apiClientProvider)
        .post(AppConstants.buyNowOrderPlace, data: orderPlaceModel.toMap());
