...
import 'package:imarketku/services/base/eCommerce/message_provider_base.dart';
...
class MessageService implements MessageProviderBase {
  ...
  Future<Response> sendMessage({
    ...
    final response = ref
        ...
        .post(
          ...
          data: {'shop_id': shopId, 'type': type, 'message': message},
        );
    return response;
  }
  ...
  Future<Response> getTotalUnreadMessages() {
    ...
    final response = ref
        .read(apiClientProvider)
        .get(AppConstants.unreadMessage, query: {'user_id': userId});
    return response;
  }
}
