...
import 'package:imarketku/services/base/eCommerce/address_provider_base.dart';
...
class AddressService implements AddressProviderBase {
  ...
  Future<Response> addAddress({required AddAddress addAddress}) async {
    final response = await ref
        ...
        .post(AppConstants.addAddess, data: addAddress.toMap()..remove('id'));
    return response;
  }
